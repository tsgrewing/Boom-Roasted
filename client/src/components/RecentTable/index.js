                ...
                {this.props.contents[0] ? (
                  this.props.contents.map((green) => (
                    <tr key={green._id + "row"} data-tip data-for={green._id}>
                      ...
                      <td key={green._id + "weight"}>
                        {green.weight} lbs
                        <ReactTooltip id={green._id} place="right">
                          <ul>
                  ...
                  <tr>
                    <td colSpan="2">No coffees in inventory yet...</td>
                  </tr>
                )}
              </tbody>
            </>
              ...
              <tbody>
                {this.props.contents[0] ? (
                  this.props.contents.map((batch) => {
                    ...
                    const roastDate =
                      month + "/" + day + "/" + year + " " + roastTime;
                    return (
                      <tr key={batch._id + "row"} data-tip data-for={batch._id}>
                        <td key={batch.name}>{batch.name}</td>
                        <td key={batch._id + "date"}>
                          {roastDate}
                          <ReactTooltip id={batch._id} place="right">
                            <ul>
                  ...
                  <tr>
                    <td colSpan="2">You haven't saved any roasts yet...</td>
                  </tr>
                )}
              </tbody>
            </>
