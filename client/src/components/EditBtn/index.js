...
class EditBtn extends Component {
  ...
  updateCoffee(e) {
    ...
    e.preventDefault();
    axios
      .put(`/api/coffees/${this.props.coffee._id}`, {
        name,
        process,
        country,
        cost,
    ...
    return (
      <>
        <button
          ...
          data-target={"edit" + this.props.coffee._id}
        >
              ...
              <form className="col s12" onSubmit={this.updateCoffee}>
                <div className="row">
                  ...
                  <div className="input-field col s6">
                    ...
                    <input
                      id={this.props.coffee._id + " :process"}
                      type="text"
                      className="validate"
                      name="process"
                ...
                <div className="row">
                  <div className="input-field col s4">
                    ...
                    <input
                      id={this.props.coffee._id + " :country"}
                      type="text"
                      className="validate"
                      name="country"
                  ...
                  <div className="input-field col s4">
                    ...
                    <input
                      id={this.props.coffee._id + " :weight"}
                      type="text"
                      className="validate"
                      name="weight"
