    ...
    return (
      <div className="InvTableWrapper">
        <div className="row left-align">
          ...
          <AddGreen updateInv={this.getInventory} />
        </div>
        <table className="centered highlight responsive-table">
          ...
          <tbody>
            {this.state.inventory ? (
                ...
                if (coffee.weight > 0 || this.state.listStatus) {
                  return (
                    <tr key={coffee._id}>
                      ...
                      <td key={coffee._id + " totalCost"}>
                        ${coffee.cost * coffee.weight}
                      </td>
                      ...
                      <td
                        key={"delete: " + coffee._id}
                        id={"delete " + coffee.name}
                      >
                        <DeleteGreen
                          updateInv={this.getInventory}
                          coffee={coffee}
              ...
              <div className="row">
                <div className="col center-align">No Coffees in Inventory</div>
              </div>
            )}
          </tbody>
        </table>
